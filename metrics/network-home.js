jQuery(document).ready(function(){
    ...
    chartDiv.empty().html(`
        <span class="section-header">${window.lodash.escape( network_base_script.trans.home_1 ) /*Active Totals for All Sites*/}</span>
            ...
            <div class="grid-x grid-padding-x grid-padding-y">
              <div class="cell">
              <span class="section-header">${window.lodash.escape( network_base_script.trans.home_1 ) /*Active Totals for All Sites*/}</span><br>
                <div class="grid-x callout">
                <div class="medium-2 cell center">
                    <h4>${window.lodash.escape( network_base_script.trans.contacts ) /*Contacts*/}<br><a href="/network/statistics/contacts"><span class="total_contacts">${spinner}</span></a></h4>
                  </div>
                  <div class="medium-2 cell center" style="border-left: 1px solid #ccc">
                    <h4>${window.lodash.escape( network_base_script.trans.groups ) /*Groups*/}<br><a href="/network/statistics/groups"><span class="total_groups">${spinner}</span></a></h4>
                  </div>
                  <div class="medium-2 cell center" style="border-left: 1px solid #ccc">
                    <h4>${window.lodash.escape( network_base_script.trans.users ) /*Users*/}<br><a href="/network/statistics/users"><span id="total_users">${spinner}</span></a></h4>
                  </div>
                  <div class="medium-2 cell center" style="border-left: 1px solid #ccc">
                    <h4>${window.lodash.escape( network_base_script.trans.sites ) /*Sites*/}<br><a href="/network/sites/"><span class="total_sites">${spinner}</span></a></h4>
                  </div>
                  <div class="medium-2 cell center" style="border-left: 1px solid #ccc">
                    <h4>${window.lodash.escape( network_base_script.trans.home_2 ) /*Countries*/}<br><a href="/network/maps/locationlist"><span id="total_countries">${spinner}</span></a></h4>
                  </div>
                  <div class="medium-2 cell center" style="border-left: 1px solid #ccc">
                    <h4>${window.lodash.escape( network_base_script.trans.home_3 ) /*Events (30 Days)*/}<br><a href="/network/activity/stream"><span class="total_activity">${spinner}</span></a></h4>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="grid-x grid-padding-x grid-margin-x">
                ...
                <div class="medium-6 cell" >
                    <div class="grid-x grid-padding-x grid-padding-y grid-margin-y">
                      <div class="cell">
                        <span class="section-header">${window.lodash.escape( network_base_script.trans.sites ) /*Sites*/}</span><br>
