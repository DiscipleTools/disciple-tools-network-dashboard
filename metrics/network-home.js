    ...
    chartDiv.empty().html(`
        <span class="section-header">${_.escape( network_base_script.trans.home_1 ) /*Active Totals for All Sites*/}</span>
            ...
            <div class="grid-x grid-padding-x grid-padding-y">
              <div class="cell">
              <span class="section-header">${_.escape( network_base_script.trans.home_1 ) /*Active Totals for All Sites*/}</span><br>
                <div class="grid-x callout">
                <div class="medium-2 cell center">
                    <h4>${_.escape( network_base_script.trans.contacts ) /*Contacts*/}<br><a href="/network/statistics/contacts"><span class="total_contacts">${spinner}</span></a></h4>
                  </div>
                  <div class="medium-2 cell center" style="border-left: 1px solid #ccc">
                    <h4>${_.escape( network_base_script.trans.groups ) /*Groups*/}<br><a href="/network/statistics/groups"><span class="total_groups">${spinner}</span></a></h4>
                  </div>
                  <div class="medium-2 cell center" style="border-left: 1px solid #ccc">
                    <h4>${_.escape( network_base_script.trans.users ) /*Users*/}<br><a href="/network/statistics/users"><span id="total_users">${spinner}</span></a></h4>
                  </div>
                  <div class="medium-2 cell center" style="border-left: 1px solid #ccc">
                    <h4>${_.escape( network_base_script.trans.sites ) /*Sites*/}<br><a href="/network/sites/"><span class="total_sites">${spinner}</span></a></h4>
                  </div>
                  <div class="medium-2 cell center" style="border-left: 1px solid #ccc">
                    <h4>${_.escape( network_base_script.trans.home_2 ) /*Countries*/}<br><a href="/network/maps/locationlist"><span id="total_countries">${spinner}</span></a></h4>
                  </div>
                  <div class="medium-2 cell center" style="border-left: 1px solid #ccc">
                    <h4>${_.escape( network_base_script.trans.home_3 ) /*Events (30 Days)*/}<br><a href="/network/activity/stream"><span class="total_activity">${spinner}</span></a></h4>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="grid-x grid-padding-x grid-margin-x">
                <div class="medium-6 cell">
                    ...
                    <div class="grid-x grid-padding-x grid-padding-y grid-margin-y">
                      <div class="cell">
                        <span class="section-header">${_.escape( network_base_script.trans.new_groups  )/*New Groups*/}</span><br>
                        <button class="button hollow new-group-buttons" id="g-7-days" onclick="load_line_chart( 'global-groups-chart-div', null, 'days', 7 );set_buttons('new-group-buttons', 'g-7-days' )">${_.escape( network_base_script.trans.last_7_days ) /*Last 7 days*/}</button> 
                        <button class="button new-group-buttons" id="g-30-days"  onclick="load_line_chart( 'global-groups-chart-div', null, 'days', 30 );set_buttons('new-group-buttons', 'g-30-days' )">${_.escape( network_base_script.trans.last_30_days ) /*Last 30 days*/}</button> 
                        <button class="button hollow new-group-buttons" id="g-60-days"  onclick="load_line_chart( 'global-groups-chart-div', null, 'days', 60 );set_buttons('new-group-buttons', 'g-60-days' )">${_.escape( network_base_script.trans.last_60_days ) /*Last 60 days*/}</button> 
                        <button class="button hollow new-group-buttons" id="g-12-months"  onclick="load_line_chart( 'global-groups-chart-div', null, 'months', 12 );set_buttons('new-group-buttons', 'g-12-months' )">${_.escape( network_base_script.trans.last_12_months ) /*Last 12 Months*/}</button>
                        <button class="button hollow new-group-buttons" id="g-24-months"  onclick="load_line_chart( 'global-groups-chart-div', null, 'months', 24 );set_buttons('new-group-buttons', 'g-24-months' )">${_.escape( network_base_script.trans.last_24_months ) /*Last 24 Months*/}</button>
                ...
                <div class="medium-6 cell" >
                    <div class="grid-x grid-padding-x grid-padding-y grid-margin-y">
                      <div class="cell">
                        <span class="section-header">${_.escape( network_base_script.trans.sites ) /*Sites*/}</span><br>
