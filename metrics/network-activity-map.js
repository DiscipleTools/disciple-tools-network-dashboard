jQuery(document).ready(function(){
    ...
    chartDiv.empty().html(`
            <span class="section-header">Map</span>
                  ...
                  <span class="section-header">Active Totals for All Sites </span><br>
                    <div class="grid-x callout">
                      <div class="medium-3 cell center">
                        <h4>Contacts<br><span class="total_contacts">${spinner}</span></h4>
                      </div>
                      <div class="medium-3 cell center" style="border-left: 1px solid #ccc">
                        <h4>Groups<br><span class="total_groups">${spinner}</span></h4>
                      </div>
                      <div class="medium-3 cell center" style="border-left: 1px solid #ccc">
                        <h4>Users<br><span id="total_users">${spinner}</span></h4>
                      </div>
                      <div class="medium-3 cell center" style="border-left: 1px solid #ccc">
                        <h4>Countries<br><span id="total_users">${spinner}</span></h4>
                      </div>
                    </div>
                  </div>
                </div>
