...
function write_area( settings ) {
    ...
    let status_list = `<option value="none" disabled></option>
                      <option value="none" disabled>${window.lodash.escape( network_base_script.trans.status ) /*Status*/}</option>
                      <option value="none"></option>
                      <option value="all" selected>${window.lodash.escape( network_base_script.trans.status_all ) /*Status - All*/}</option>
                      <option value="none" disabled>-----</option>
                      `
    jQuery.each(status, function(i,v){
        status_list += `<option value="${i}">${window.lodash.escape( v.label )}</option>`
    })
                        ...
                        <div class="grid-x grid-margin-x grid-padding-x">
                            ...
                            <div class="cell small-2 center border-left">
                                <select id="level" class="small" style="width:170px;">
                                    <option value="none" disabled></option>
                                    <option value="none" disabled>${window.lodash.escape( network_base_script.trans.zoom_level ) /*Zoom Level*/}</option>
                                    <option value="none"></option>
                                    <option value="auto" selected>${window.lodash.escape( network_base_script.trans.auto_zoom ) /*Auto Zoom*/}</option>
                                    <option value="none" disabled>-----</option>
                                    <option value="world">${window.lodash.escape( network_base_script.trans.world ) /*World*/}</option>
                                    <option value="admin0">${window.lodash.escape( network_base_script.trans.country ) /*Country*/}</option>
                                    <option value="admin1">${window.lodash.escape( network_base_script.trans.state ) /*State*/}</option>
                                    <option value="none" disabled></option>
                                </select>
                            </div>
                            <div class="cell small-2 center border-left">
                        ...
                        if ( details.admin0_grid_id ) {
                            list.append( `
                              <div id="admin0_wrapper" class="cell callout center">
                               <h4>${window.lodash.escape( details.admin0_name )}</h4><h4><span id="admin0_count">0</span></h4>
                              </div>
                            `)
