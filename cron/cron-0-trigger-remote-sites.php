...
add_action('dt_network_dashboard_trigger_sites_1am', 'dt_network_dashboard_remote_sites_trigger');
...
add_action('dt_network_dashboard_trigger_sites_2am', 'dt_network_dashboard_remote_sites_trigger');
...
add_action('dt_network_dashboard_trigger_sites_3am', 'dt_network_dashboard_remote_sites_trigger');
...
add_action('dt_network_dashboard_trigger_sites_4am', 'dt_network_dashboard_remote_sites_trigger');
...
add_action('dt_network_dashboard_trigger_sites_5am', 'dt_network_dashboard_remote_sites_trigger');
...
add_action('dt_network_dashboard_trigger_sites_6am', 'dt_network_dashboard_remote_sites_trigger');
