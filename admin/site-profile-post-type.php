...
/**
 * DT_Site_Profile_Post_Type Post Type Class
 * All functionality pertaining to project update post types in DT_Site_Profile_Post_Type.
 *
 * @package  Disciple_Tools
 * @since    0.1.0
 */
class DT_Site_Profile_Post_Type
{
    /**
     * The post type token.
     *
    ...
    /**
     * DT_Site_Profile_Post_Type The single instance of DT_Site_Profile_Post_Type.
     * @var     object
     * @access  private
     * @since   0.1
     */
    ...
    /**
     * Main DT_Site_Profile_Post_Type Instance
     *
     * Ensures only one instance of DT_Site_Profile_Post_Type is loaded or can be loaded.
     *
     * @since 0.1
     * @static
     * @return DT_Site_Profile_Post_Type instance
     */
     ...
     */
    public function __construct( $post_type = 'site_profile', $singular = 'Site Profile', $plural = 'Site Profiles', $args = [], $taxonomies = [] ) {
        ...
        if ( is_admin() ) {
            ...
            add_action( 'admin_menu', [ $this, 'meta_box_setup' ], 99 );
    ...
    public function register_post_type() {
        register_post_type( $this->post_type, /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
            ...
            array(
                'labels' => array(
                    'name' => __( 'Site Profile', 'zume' ), /* This is the Title of the Group */
                    'singular_name' => __( 'Site Profile', 'zume' ), /* This is the individual type */
                    'all_items' => __( 'All Site Profiles', 'zume' ), /* the all items menu item */
                    'add_new' => __( 'Add New', 'zume' ), /* The add new menu item */
                    'add_new_item' => __( 'Add New Site Profile', 'zume' ), /* Add New Display Title */
                    'edit' => __( 'Edit', 'zume' ), /* Edit Dialog */
                    'edit_item' => __( 'Edit Site Profile', 'zume' ), /* Edit Display Title */
                    'new_item' => __( 'New Site Profile', 'zume' ), /* New Display Title */
                    'view_item' => __( 'View Site Profile', 'zume' ), /* View Display Title */
                    'search_items' => __( 'Search Site Profiles', 'zume' ), /* Search Custom Type Title */
                ...
                'description' => __( 'Network Dashboard Site Profile', 'zume' ), /* Custom Type Description */
                'public' => false,
                ...
                'rewrite' => array( 'slug' => 'site_profile', 'with_front' => false ), /* you can specify its url slug */
    ...
    public function updated_messages( $messages ) {
        ...
        $messages[ $this->post_type ] = [
            ...
            2  => 'Site Profile updated.',
            3  => 'Site Profile deleted.',
...
DT_Site_Profile_Post_Type::instance();