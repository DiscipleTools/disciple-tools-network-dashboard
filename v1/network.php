...
if ( ! class_exists( 'Disciple_Tools_Cron_Snapshot_Scheduler' ) ) {
...
if ( ! class_exists( 'Disciple_Tools_Cron_Snapshot_Async' ) ) {
...
if ( ! class_exists('Disciple_Tools_Snapshot_Report' ) ) {
